    ...
    <section className="relative bg-teal-deep py-20 md:py-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="space-y-6">
          {projects.map((p, i) => (
            <Reveal key={p._id.toString()} delay={i * 100}>
              <a href={`/projects/${p.slug}`} className="group grid md:grid-cols-2 border border-white/10 hover:border-gold-soft/50 transition-colors duration-500 bg-ink/20">
